...
- **`price_model.py`**: Trained three **stock movement prediction models**, Random Forests, ANN, LSTM, with **average accuracy around 55%, precision around 56%**, specifically for **AAPL**. The result may vary across companies, with close backtesting results.
